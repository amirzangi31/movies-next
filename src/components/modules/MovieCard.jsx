  ...
  return (
    <Link href={`/${local}/favorites`}  className='movie-card shadow-sh-black' >
            <div  className='movie-card__body'>
                ...
                <div className='flex justify-between items-start flex-col gap-2 text-[10px] xs:text-sm font-[300]'> 
            ...
            <Image src={"/movie-one.png"} className='movie-card__image'  width={400} height={400} alt='cover-card'  />
    </Link>
  )
}
