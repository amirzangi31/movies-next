...
const Searchbox = () => {
  return (
    <div className='bg-[#303030]  flex justify-start items-center gap-4 px-4 py-2 rounded-3xl w-full'>
            ...
            <input type="text" className='flex-1 text-text text-md  placeholder:text-text placeholder:text-md ' placeholder='جستجوی فیلم و سریال ...' />
    </div>
  )
}
